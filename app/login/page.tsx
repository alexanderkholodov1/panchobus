        ...
        <div className="w-full max-w-md space-y-5">
          <div className="text-center space-y-1">
            ...
            <p className="text-muted text-sm">
              Accede con tu cuenta institucional USFQ
            </p>
          </div>
              ...
              <form onSubmit={onSubmit} className="space-y-3.5">
                <div>
                  ...
                  <Input
                    id="email"
                    type="email"
                    placeholder="tu.correo@estud.usfq.edu.ec"
                    autoComplete="email"
                    value={email}
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center">
              <span className="bg-background px-2 text-xs uppercase tracking-wider text-muted">
                Demo · acceso rápido
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              onClick={() => demoLogin("estudiante")}
              className="p-3 rounded-xl bg-surface border border-border hover:border-primary hover:bg-usfq-red-tint/30 transition-all text-center group"
            >
              <GraduationCap className="w-5 h-5 mx-auto mb-1.5 text-primary" />
              <span className="text-xs font-medium block">Estudiante</span>
            </button>
            <button
            ...
            <button
              onClick={() => demoLogin("chofer")}
              className="p-3 rounded-xl bg-surface border border-border hover:border-primary hover:bg-usfq-red-tint/30 transition-all text-center group"
            >
              <Bus className="w-5 h-5 mx-auto mb-1.5 text-primary" />
              <span className="text-xs font-medium block">Chofer</span>
            </button>
          </div>
          <p className="text-center text-xs text-muted">
            Los accesos demo permiten explorar las 3 experiencias sin necesidad de cuenta.
          </p>
        </div>
      </main>
    </div>
