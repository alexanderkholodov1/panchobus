    ...
    <header className="sticky top-0 z-40 backdrop-blur-md bg-background/80 border-b border-border">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm">
          <Link href="/#como-funciona" className="text-muted hover:text-foreground transition-colors">
            Cómo funciona
          </Link>
          <Link href="/#rutas" className="text-muted hover:text-foreground transition-colors">
            Rutas
          </Link>
          <Link href="/#equipo" className="text-muted hover:text-foreground transition-colors">
            Equipo
          </Link>
        </nav>
