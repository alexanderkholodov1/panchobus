...
export function Logo({ className, variant = "full", size = 32 }: LogoProps) {
  if (variant === "mark") {
    return (
      <svg viewBox="0 0 40 48" width={size} height={size * 1.2} className={cn("inline-block", className)} aria-label="Pancho Bus">
        <defs>
        ...
        <path d="M20 2 C9.5 2 1 10.5 1 21 C1 33.5 20 46 20 46 C20 46 39 33.5 39 21 C39 10.5 30.5 2 20 2 Z" fill="url(#pin-grad)" />
  ...
  return (
    <div className={cn("inline-flex items-center gap-2", className)}>
      <svg viewBox="0 0 40 48" width={size} height={size * 1.2} aria-hidden>
        ...
        <path d="M20 2 C9.5 2 1 10.5 1 21 C1 33.5 20 46 20 46 C20 46 39 33.5 39 21 C39 10.5 30.5 2 20 2 Z" fill={`url(#pin-grad-${size})`} />
        <g transform="translate(8.5, 11)" fill="white">
          <rect x="0" y="0" width="23" height="15" rx="3" />
          <rect x="2" y="3" width="8" height="5" rx="1" fill="#E11B22" />
          <rect x="13" y="3" width="8" height="5" rx="1" fill="#E11B22" />
      ...
      <span className="font-display font-bold tracking-tight" style={{ fontSize: size * 0.85 }}>
